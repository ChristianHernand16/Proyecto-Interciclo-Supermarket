					...
					<div class="cd-dropdown-wrapper">
						...
						<nav class="cd-dropdown"> 
							...
							<ul class="cd-dropdown-content"> 
								<li><a href="offers.html">Ofertas de hoy</a></li>
								<li class="has-children">
									<a href="#">Electrónica</a> 
									<ul class="cd-secondary-dropdown is-hidden">
										<li class="go-back"><a href="#">Menu</a></li>
										<li class="see-all"><a href="products.html">Todos los electronicos</a></li>
										<li class="has-children">
											<a href="#">TELÉFONOS MÓVILES</a>  
											<ul class="is-hidden"> 
												<li class="go-back"><a href="#">Todos los electronicos</a></li> 
												<li class="has-children">
												...
												<li><a href="products.html">Teléfonos con funciones</a></li> 
											</ul>
										</li> 
										<li class="has-children">
											<a href="#">
												Grandes electrodomésticos</a> 
											<ul class="is-hidden"> 
			...
			<div class="welcome-info">
				<div  class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						<ul id="myTab" class=" nav-tabs" role="tablist">
								<h4>Quienes Somos</h4>
								<p>Supermarket Fabiola surge de la idea de tener un supermarket online con los
									mejores precios en el mercado ofreciendo productos de calidad.
								</p>
						</ul>
				</div>
			</div>
