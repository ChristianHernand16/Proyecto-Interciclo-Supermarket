                    ...
                    <div class="container"> 
                        ...
                        <div class="login-body">
                            ...
                            <form  method="POST" action="#">
                                ...
                                <input type="text" id="contraactual" class="user" name="contraactual" placeholder="Ingresa tu Contraseña Actual" value="" >

                                <label for="cedula">Contraseña Nueva</label>
                                <input type="text" id="contranueva" class="user" name="contranueva" placeholder="Ingresa tu Contraseña Nueva" value="" >
